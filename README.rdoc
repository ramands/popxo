...
2. Install the gems required by the project

<tt>bundle install</tt>

3. Create a database named souncloud. Run the following command in 

<tt>CERATE DATABASE souncloud</tt>

4. Initialize the database by running the flollowing command in the terminal

<tt>rake db:migrate</tt>

5. To run the project, run <tt>rails server</tt> from the terminal. (Make sure that the project root is your present working directory)

6. Open the project in the browser by entering localhost:3000.
